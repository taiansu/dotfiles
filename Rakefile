...
namespace :update do # rubocop: disable BlockLength
  ...
  task tasks_with_commit: %w[async_tasks source spacemacs] # rubocop: disable LineLength
  # multitask async_tasks_with_commit: %w[homebrew vim_with_commit source spacemacs] # rubocop: disable LineLength
  desc 'Update all without commit plug.vim'
  task only: %w[homebrew vim spacemacs asdf]

  %i[homebrew cask npm yarn vim vim_with_commit emacs spacemacs source asdf].each do |task_name| # rubocop: disable LineLength
